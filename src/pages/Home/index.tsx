  ...
  return (
    <Page className="home-page" withoutMargin>
      <Helmet>
        ...
        <meta
          name="description"
          content="I’m a computer science student focused on web- and app development, software engineering and photography."
        />
      </Helmet>
        ...
        <div className="content-container">
          <div className="row center">
            <div className="column large-8">
              <p className="lead">
                I’m a <strong>computer science student</strong> focused on web-
                and app development, software engineering and photography.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="column large-6">
              ...
              <p>
                ...
                If you like what you are seeing, just click on the button below,
                there is even more.
              </p>
              <Button route="/creations">All creations...</Button>
            </div>
          </div>
        </div>
